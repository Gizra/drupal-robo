...
trait ImportToConfig {
  ...
  public function localeImportToConfig(): void {
    foreach ($this->getInstalledLanguages() as $langcode) {
      $counter = 0;
   ...
   *   The translations.
   */
  protected function getTranslations(string $langcode): Translations {
    $loader = new PoLoader();
    return $loader->loadFile($this->getPoFilesPath() . "/{$langcode}_config.po");
  }
